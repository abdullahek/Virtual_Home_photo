...
<title>Virtual Home Photography</title>
...
<!--<link href="../../../../../external.html?link=https://fonts.googleapis.com/css?family=Oswald:300,400,700" rel="stylesheet">-->
<!--<link href="../../../../../external.html?link=https://fonts.googleapis.com/css?family=Montserrat:400,700" rel="stylesheet">-->
...
Virtual <br>Home<span class="text-primary"> </span><br>Photography
</a>
<div class="brand-name">Virtual Home Photography</div>
...
<div class="vertical-panel-title">Virtual Home Photography</div>
<div class="line"></div>
</div>
...
<div class="container">
<a href="#top" class="brand js-target-scroll">
Virtual Home<span class="text-primary"> </span>Photography
</a>
...
<li>
    <a href="recent_projects.php">Recent Projects</a>
</li>
<li>
...
<img src="img/data/slider-1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg">
...
<img src="img/data/slider-2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" style="background-color: rgb(0,0,0,0.6);">
...
<h2 class="section-title">About <span class="text-primary">Virtual Home Photography</span></h2>
<strong class="fade-title-left">About</strong>
</header>
<div class="section-content">
<div class="row-base row">
<div class="col-base col-sm-6 col-md-4">
<h3 class="col-about-title">Get to know us<span class="text-primary">.</span></h3>
<div class="col-about-info">
<p>Virtual Home Photography has been providing Virtual Tour and high definition photography service for Real estate Agents and Brokers since 2013. We have worked with Remax, Century 21, HomeLife, King realty Inc. and many more Brokerages. We specialize for high definition virtual tours including photography and 360 degree panoramas for small to luxury homes.
    We make sure that with our Virtual tours cover each and every corner of your property so that buyers can completely visualise it. In Today’s fast market where listings need to be up as soon as possible, we always try to provide the tour same day.</p>
</div>
</div>
...
1437 Leger Way<br>Milton Ontario L9T 7K6
</h3>
...
<div class="project">
<a href="img/projects/4-480x880.jpg" title="project 3">
<figure>
...
<div class="project">
<a href="img/projects/7-480x880.jpg" title="project 4">
<figure>
<img alt="" src="img/projects/7-480x880.jpg">
<figcaption>
<h3 class="project-title">
78 Saintsbury Crescent <br>Brampton, Ontario L6R 2V8
</h3>
<h4 class="project-category">
...
<div class="col-base col-service col-sm-12 col-md-6 wow fadeInUp">
    <div class="service-item">
    <img alt="" src="img/data/bg_right.jpg" height="380px" width="100%">
    <h4>Photos</h4>
    <p><b>It is rightly said that ” A picture is worth a thousand words”.</b><br>Well, Imagine plenty of pictures describing your property. Yes, we provide as many pictures as required to completely cover your property. We take enough time to capture each and every corner of your home but fast enough that property is listed within same day.</p>
    </div>
    <a href="pricing.php" class="btn btn-shadow-2 wow swing">Order Now<i class="icon-next"></i></a>
</div>
<div class="col-base col-service col-sm-12 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
    <div class="service-item">
        <iframe width="100%" height="380px" src="https://www.youtube.com/embed/aCMXrvVXmTE" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    <h4>Virtual Tour</h4>
    <p><b>A Virtual tour is created by stitching multiple photos. It is also known as 360 degree Panorama.</b><br> For each project we establish relationships with partners who we know will help us create added value for your project. As well as bringing together the public and private sectors, we make sector-overarching links to gather knowledge and
...
<div class="col-base col-service col-sm-12 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
    <div class="service-item">
       	<iframe width="100%" height="380px" src="https://www.youtube.com/embed/39umUxhWAaY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    <h4>Aerial</h4>
    <p>Aerial Photography/Video of the Property</p>
    </div>
    <a href="pricing.php" class="btn btn-shadow-2 wow swing">Order Now<i class="icon-next"></i></a>
</div>
...
<div class="col-base col-service col-sm-12 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
    <div class="service-item">
       	<iframe width="100%" height="380" src="https://www.youtube.com/embed/25gkCbKTpB0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
    <h4>3D Tour</h4>
    <p> 3D Tour of Property with MatterPort</p>
    </div>
    <a href="pricing.php" class="btn btn-shadow-2 wow swing">Order Now<i class="icon-next"></i></a>
</div>
...
Brampton, Ontario<br>
647-390-6555<br>
<a href="mailto:virtualhomephotography@gmail.com" class="__cf_email__" data-cfemail="85ecebe3eac5e2eae4f7e6edabe6eae8">virtualhomephotography@gmail.com</a><br>
</div>
<div class="col-base  col-md-8">
<form class="js-ajax-form" name="submitForm" action="" method="POST">
<div class="row-field row">
<div class="col-field col-sm-6 col-md-4">
<div class="form-group">
<input type="text" class="form-control" name="name" id="_name" placeholder="Name">
</div>
<div class="form-group">
<input type="email" class="form-control" name="email" id="_email" required placeholder="Email *">
</div>
</div>
<div class="col-field col-sm-6 col-md-4">
<div class="form-group">
<input type="tel" class="form-control" name="phone" id="_phone" placeholder="Phone">
</div>
<div class="form-group">
...
<div class="form-group">
<textarea class="form-control" name="message" id="_message" placeholder="Message"></textarea>
</div>
</div>

<!--<div class="col-message col-field col-sm-12">-->
    <div class="form-group">
        <div id="success"><i class="fa fa-check text-primary"></i> Thank you!. Your message is successfully sent...</div>
        <div id="error">We're sorry, but something went wrong</div>
    </div>
<!--</div>-->

</div>
<div class="form-submit text-right"><button type="button" class="btn btn-shadow-2 wow swing" onclick="sendContactUsMail();">Send <i class="icon-next"></i></button></div>
</form>
</div>
</div>
</div>
...
© virtual home photography 2020. All Rights Reserved.
</div>
</div>
</div>
</footer>
